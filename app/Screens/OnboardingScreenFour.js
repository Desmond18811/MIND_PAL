...
// Define colors based on the reference screen
const Colors = {
  lightGreenBackground: '#FFF4E0', // Background color of the top section
  darkBrown: '#6B3F25',             // Color for text, button border, and arrow button
  greenish: '#FFCE5C',              // Highlight color for text
...
const OnboardingScreenFour = ({ navigation }) => {
  const handleNextPress = () => {
    // Replace 'NextScreen' with your target screen (e.g., 'Home' or 'OnboardingComplete')
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.contentOverlay}>
        ...
        <TouchableOpacity style={styles.stepButton}>
          <Text style={styles.stepButtonText}>Step Four</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.bottomSection}>
        ...
        <Text style={styles.mainText}>
          Mindful <Text style={styles.highlightText}>Resources</Text> That
        </Text>
        <Text style={styles.mainText}>Make You Happy</Text>
...
const styles = StyleSheet.create({
  ...
  progressBarActive: {
    width: '80%', // Adjusted for Step Four (e.g., 4/5 steps)
    height: '100%',
