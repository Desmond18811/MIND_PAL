...
const Colors = {
  ...
  greenish: '#85B26E',              // Highlight color for text
...
const OnboardingScreenThree = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Image
        source={require('../assets/jornalising.png')}
      ...
      <View style={styles.contentOverlay}>
        ...
        <TouchableOpacity style={styles.stepButton}>
          <Text style={styles.stepButtonText}>Step Three</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.bottomSection}>
        ...
        <Text style={styles.mainText}>
          AI Mental{' '}
          <Text style={styles.highlightText}>Journaling</Text> & Therapy Chatbot
        </Text>
...
const styles = StyleSheet.create({
  ...
  progressBarActive: {
    width: '60%', // Adjusted for Step Three (e.g., 3/5 steps)
    height: '100%',
